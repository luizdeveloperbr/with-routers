  ...
  <div class="dropdown-menu" id="dropdown-menu4" role="menu">
    <div class="dropdown-content">
      <div class="dropdown-item" v-for="set in setores">
        <a @click="setor = set"><p class="is-uppercase">{{set}}<p></a>
      </div>
    </div>
  </div>
</div>
          ...
          <div class="level-right">
            <p class="content is-small">LIDER COMERCIO E IND. LTDA
              <br>ROD BR-316 KM 02 - GUANABARA - ANINDEUA
              <br>(91) 4008-1012 | CNPJ: 05.054.671/0014-73</p>
          </div>
        </div>
      </div>
