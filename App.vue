    ...
    <div class="navbar-item">Setor:</div>
      ...
      <div class="field is-grouped">
        ...
        <div class="navbar-dropdown is-right">
          ...
          <a class="navbar-item" @click="hmodalActive = true">
            Add Horario
          </a>
        </div>
      </div>
...
<div class="level-item has-text-weight-bold has-text-centered">Escala<br>{{$route.name}} {{monthpick}}<br>Setor: {{$route.query.setor}}</div>
<div class="level-right"><p class="content is-small">LIDER COMERCIO E IND. LTDA<br>ROD BR 316 KM 02 - GUANABARA- ANANINDEUA<br>CNPJ:05.054.671/0014-73</p></div>
</div>
</div>
...
<div class="field">
  ...
  <div class="control">
    ...
    <footer class="modal-card-foot">
      <button class="button is-success" @click="addTime">Salvar</button>
...
// @import "./node_modules/bulma-calendar/src/sass";
</style>